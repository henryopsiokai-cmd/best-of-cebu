  ...
  return (
    <div className="min-h-screen bg-white text-stone-900 font-serif">
      ...
      <article className="max-w-3xl mx-auto px-6 pb-24">
        ...
        <AnimatedSection>
          <H2 className="italic border-b-2 border-stone-900 inline-block pb-2 mb-8 uppercase text-sm tracking-widest">The Tradition of Tablea</H2>
          <Paragraph>
        ...
        <AnimatedSection>
          <H2 className="italic border-b-2 border-stone-900 inline-block pb-2 mb-8 uppercase text-sm tracking-widest">The Half-Moon View</H2>
          <Paragraph>
        ...
        <AnimatedSection>
          <div className="my-16 space-y-8 font-sans">
            <div className="p-8 border-l-4 border-amber-600 bg-stone-50 rounded-none shadow-sm">
