  ...
  return (
    <div className="min-h-screen bg-white text-stone-900 font-serif">
      ...
      <ArticleHeader
        ...
        subtitle="An intimate fine dining experience featuring contemporary Italian cuisine with a local twist, tucked away in a welcoming neighborhood setting."
        author="Criste Joy"
        publishedAt="February 2026"
        imageSrc="https://drive.google.com/thumbnail?id=118SI_2XkELMzO2wbHo3YC6JwpAjkuoJc&sz=w1600"
      />

      <article className="max-w-4xl mx-auto px-6 pb-24">
        <DropCap>
          Amato quietly occupies a corner of Cebu's dining scene without needing to shout. The restaurant, located in a convenient Banilad-area location, offers an intimate setting where contemporary Italian cooking meets thoughtful local flavor interpretations. It's the kind of place that rewards those who appreciate careful execution over showy presentations.
        </DropCap>
        ...
        <AnimatedSection>
          <div className="my-16 aspect-video bg-stone-100 rounded-lg overflow-hidden flex items-center justify-center border group relative shadow-2xl">
             <iframe
              ...
              src="https://www.youtube-nocookie.com/embed/ajOhaFpvTdk"
        ...
        <Gallery 
          images={["1ePDAMQIWtavuVMsAhFU4SsSP1hcLSrRM","1v_XoKcnVjJNkadqOqptf2HuHTx90YWNE","1x3XBfzesTrF-yqQMmMm2IVNJrPCCuxP3","1ZfuzNBOKzgdvBUDRroZMrajfYVe9aq3X","1B3ksD8INvLngIUDMJkjvCg8J_ciKspdN","1lseflMZR-LjzFnNjOn_PpiL9zmxiLy0t","17ZKWmCtPqTfSTmB9oCezEIbvJFU62Llb","184KZRDa2gwVR7pjIfwuEW41OFBqfJfhS","1f_3NyV4qHh1xaljy0MDygXYNsEb5a-UR","1b05M4uq8B9sVNKf3r8-un9w96VZC0u7u","1qOJFm7aLUGlSp_SXmQtV4YcwP8tEUDuc","11sU6pCRidnsSimPs8Q2BwjD-jhDc1-TN","1Ga_r-evLWDXvYR4gJsDM9130VwWKLvJ7","18b9JXIdrDunK2E0vv5pi67YPsy9hMnUH"]} 
        />
      </article>
