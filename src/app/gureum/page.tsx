        ...
        <AnimatedSection>
          <div className="my-16 grid grid-cols-1 md:grid-cols-2 gap-8 font-sans">
            <div className="p-8 bg-stone-50 border shadow-sm">
              ...
              <p className="text-sm text-stone-600 italic">Very friendly staff (Rating: 5/5) and record-fast service (~8 mins). Perfect for a quick, quality lunch.</p>
            </div>
            <div className="p-8 bg-stone-50 border shadow-sm">
              <h3 className="text-amber-600 font-bold uppercase tracking-widest text-xs mb-2">Policy & Vibes</h3>
              <p className="text-sm text-stone-600 italic">2.5 hour stay limit. Vibe: Chill, Cozy, Relaxing. Great for work-from-cafe sessions.</p>
            </div>
          </div>
        </AnimatedSection>
      </article>
